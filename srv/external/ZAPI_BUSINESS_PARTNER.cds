/* checksum : 3292f07bf97c4ccedf7ea7cdfe64a171 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service ZAPI_BUSINESS_PARTNER {};

@cds.external : true
@cds.persistence.skip : true
@sap.content.version : '1'
@sap.label : 'Email Address'
entity ZAPI_BUSINESS_PARTNER.A_AddressEmailAddress {
...
entity ZAPI_BUSINESS_PARTNER.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity ZAPI_BUSINESS_PARTNER.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity ZAPI_BUSINESS_PARTNER.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity ZAPI_BUSINESS_PARTNER.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity ZAPI_BUSINESS_PARTNER.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many ZAPI_BUSINESS_PARTNER.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressPhoneNumber {  };
  to_URLAddress : Association to many ZAPI_BUSINESS_PARTNER.A_AddressHomePageURL {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Industry'
entity ZAPI_BUSINESS_PARTNER.A_BuPaIndustry {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Industry'
...
@sap.content.version : '1'
@sap.label : 'Business Partner'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_BPCreditWorthiness : Association to ZAPI_BUSINESS_PARTNER.A_BPCreditWorthiness {  };
  to_BPDataController : Association to many ZAPI_BUSINESS_PARTNER.A_BPDataController {  };
  to_BPFinServicesReporting : Association to ZAPI_BUSINESS_PARTNER.A_BPFinancialServicesReporting {  };
  to_BPFiscalYearInformation : Association to many ZAPI_BUSINESS_PARTNER.A_BPFiscalYearInformation {  };
  to_BPRelationship : Association to many ZAPI_BUSINESS_PARTNER.A_BPRelationship {  };
  to_BuPaIdentification : Association to many ZAPI_BUSINESS_PARTNER.A_BuPaIdentification {  };
  to_BuPaIndustry : Association to many ZAPI_BUSINESS_PARTNER.A_BuPaIndustry {  };
  to_BusinessPartner : Association to ZAPI_BUSINESS_PARTNER.A_BPFinancialServicesExtn {  };
  to_BusinessPartnerAddress : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerAddress {  };
  to_BusinessPartnerBank : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerBank {  };
  to_BusinessPartnerContact : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerContact {  };
  to_BusinessPartnerRating : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerRating {  };
  to_BusinessPartnerRole : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerRole {  };
  to_BusinessPartnerTax : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerTaxNumber {  };
  to_BusPartAddrDepdntTaxNmbr : Association to many ZAPI_BUSINESS_PARTNER.A_BusPartAddrDepdntTaxNmbr {  };
  to_Customer : Association to ZAPI_BUSINESS_PARTNER.A_Customer {  };
  to_PaymentCard : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerPaymentCard {  };
  to_Supplier : Association to ZAPI_BUSINESS_PARTNER.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  to_AddressUsage : Association to many ZAPI_BUSINESS_PARTNER.A_BuPaAddressUsage {  };
  to_BPAddrDepdntIntlLocNumber : Association to ZAPI_BUSINESS_PARTNER.A_BPAddrDepdntIntlLocNumber {  };
  to_BPIntlAddressVersion : Association to many ZAPI_BUSINESS_PARTNER.A_BPIntlAddressVersion {  };
  to_EmailAddress : Association to many ZAPI_BUSINESS_PARTNER.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many ZAPI_BUSINESS_PARTNER.A_AddressPhoneNumber {  };
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  @sap.quickinfo : 'Business Partner Relationship Category'
  RelationshipCategory : String(6);
  to_ContactAddress : Association to many ZAPI_BUSINESS_PARTNER.A_BPContactToAddress {  };
  to_ContactRelationship : Association to ZAPI_BUSINESS_PARTNER.A_BPContactToFuncAndDept {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Role'
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity ZAPI_BUSINESS_PARTNER.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Customer'
entity ZAPI_BUSINESS_PARTNER.A_Customer {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.label : 'County Code'
  County : String(3);
  to_CustAddrDepdntExtIdentifier : Association to many ZAPI_BUSINESS_PARTNER.A_CustAddrDepdntExtIdentifier {  };
  to_CustAddrDepdntInformation : Association to many ZAPI_BUSINESS_PARTNER.A_CustAddrDepdntInformation {  };
  to_CustomerCompany : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerCompany {  };
  to_CustomerSalesArea : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerSalesArea {  };
  to_CustomerTaxGrouping : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerTaxGrouping {  };
  to_CustomerText : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerText {  };
  to_CustomerUnloadingPoint : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerUnloadingPoint {  };
  to_CustUnldgPtAddrDepdntInfo : Association to many ZAPI_BUSINESS_PARTNER.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_CompanyText : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerCompanyText {  };
  to_CustomerDunning : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerDunning {  };
  to_WithHoldingTax : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerWithHoldingTax {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_PartnerFunction : Association to many ZAPI_BUSINESS_PARTNER.A_CustSalesPartnerFunc {  };
  to_SalesAreaTax : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerSalesAreaTax {  };
  to_SalesAreaText : Association to many ZAPI_BUSINESS_PARTNER.A_CustomerSalesAreaText {  };
  to_SlsAreaAddrDepdntInfo : Association to many ZAPI_BUSINESS_PARTNER.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  to_SlsAreaAddrDepdntTax : Association to many ZAPI_BUSINESS_PARTNER.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Supplier'
entity ZAPI_BUSINESS_PARTNER.A_Supplier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  ...
  to_SupplierCompany : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierCompany {  };
  to_SupplierPurchasingOrg : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierPurchasingOrg {  };
  to_SupplierText : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierText {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
  ...
  @sap.quickinfo : 'Vendor account group'
  SupplierAccountGroup : String(4);
  to_CompanyText : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierCompanyText {  };
  to_Supplier : Association to ZAPI_BUSINESS_PARTNER.A_Supplier {  };
  to_SupplierDunning : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierDunning {  };
  to_SupplierWithHoldingTax : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierWithHoldingTax {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  @sap.quickinfo : 'Vendor account group'
  SupplierAccountGroup : String(4);
  to_PartnerFunction : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierPartnerFunc {  };
  to_PurchasingOrgText : Association to many ZAPI_BUSINESS_PARTNER.A_SupplierPurchasingOrgText {  };
};
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
